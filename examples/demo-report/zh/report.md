...
### 术语含义在后续才明确 · 双方对同一个词理解不同

- **当时怎么说：** 让存储体验对新手更友好。
- **后来怎样补充：** 我说的是本地 JSON 存储，不是托管服务。所有任务数据都保留在设备上。
- **偏差出现在哪里：** 双方围绕同一个词继续对话，但这个词指向的对象并不相同。
- **观察到的项目证据：** 澄清后 24 小时内观察到 1 次主题相关提交；时间接近不等同于因果。
- **当时缺少的信息：** 核心术语的具体含义、不包含的解释
- **下次可以这样说：** 请按这个完整要求执行：本地 JSON 存储，不是托管服务。所有任务数据都保留在设备上。开始前先复述你理解的目标、范围和不改动的部分。
- **可以复用的表达方式：** 我说的[术语]是[具体含义]，不是[容易混淆的解释]；目标是[预期结果]。
- **需要你确认：** 这里是否更像双方对同一个词的理解不同？
...
- **观察到的项目证据：** 澄清后 24 小时内观察到 1 次主题相关提交；时间接近不等同于因果。
- **当时缺少的信息：** 必须保留的行为、明确禁区
- **下次可以这样说：** 请按这个完整要求执行：为本地存储和 JSON 导出增加自动化测试，不要增加云端依赖。开始前先复述你理解的目标、范围和不改动的部分。
...
- **观察到的项目证据：** 澄清后 24 小时内观察到 1 次主题相关提交；时间接近不等同于因果。
- **当时缺少的信息：** 具体对象、修改范围
- **下次可以这样说：** 请按这个完整要求执行：记录为什么选择本地优先导出而不是隐藏云同步，不只是说明命令行怎么用。开始前先复述你理解的目标、范围和不改动的部分。
